...
## [ADB](https://so.csdn.net/so/search?q=ADB&spm=1001.2101.3001.7020)调试工具安装

### 下载Android Platform Tools

到Android开发[官网](https://developer.android.com/studio/releases/platform-tools.html)下载Android Platform Tools并解压，解压后可以看到文件夹platform-tools，里面包含adb调试工具。
无法访问官网的小伙伴可以去第三方网站下载，或者直接从以下百度云链接下载：
链接：https://pan.baidu.com/s/1TZI6W0npBeon9UCffjNPRQ
提取码：5nq0
![1](/../image/ABD/1.png)

### 环境变量设置

打开“我的电脑->属性->系统高级设置->环境变量”，在Path变量中添加platform-tools文件夹的路径和%Android%：![2](/../image/ABD/2.png)

### 运行ADB

打开命令行窗口，输入adb，能打印出adb的版本号和用法，即为安装成功。
![3](/../image/ABD/3.png)
